...
alias dwrznet_publish="rsync -av --progress --delete ~/ruck/pd/dwrznet/www/ -e 'ssh -p 8822 -i ~/.ssh/srv-nyc' dwrz@dwrz.net:/home/dwrz/www/"
...
alias mkdir="mkdir -p"
alias ml="xrandr --output eDP-1 --auto --output HDMI-2 --auto --brightness 0.8"
